...
- [async](./rust/async/index.md)
  - [Asynchronous Cooking](./rust/async/cooking.md)
  ...
  - [Count in parallel with random sleep](./rust/async/count-in-parallel-with-random-sleep.md)
  ...
  - [JoinSet random order of completion](./rust/async/join-set-order.md)
- [HTTP server]()
