fn main() {
    ...
    println!("weight in metric ton: {}", (weight_in_gram / 1000.0 / 1000.0).round());
    println!("weight in metric ton: {}", commafy((weight_in_gram / 1000.0 / 1000.0).round() as u128));
}


pub fn commafy<Integer: Into<u128> +  Copy + std::fmt::Debug + std::fmt::Display>(num: Integer) -> String {
    let num = format!("{num}");
    let mut ix = 0;
